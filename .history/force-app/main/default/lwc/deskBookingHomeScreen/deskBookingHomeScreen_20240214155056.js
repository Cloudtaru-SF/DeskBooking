...
export default class DeskBookingHomeScreen extends LightningElement {
    ...
    inputsHandler(event){
        ...
        alert(this.buildingOptions.find(floor => floor.value = this.buildingName).label);
